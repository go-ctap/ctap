// Code generated by "stringer -type=Command,ClientPINSubCommand,BioEnrollmentSubCommand,LastEnrollSampleStatus,CredentialManagementSubCommand,ConfigSubCommand -output=consts_string.go"; DO NOT EDIT.
