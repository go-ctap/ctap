// Code generated by "stringer -type=Command,ClientPINSubCommand,BioEnrollmentSubCommand,CredentialManagementSubCommand,ConfigSubCommand -output=consts_string.go"; DO NOT EDIT.
